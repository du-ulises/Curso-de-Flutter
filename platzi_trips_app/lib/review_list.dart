...
class ReviewList extends StatelessWidget{
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: <Widget>[
        Review("assets/images/people.jpg", "Diego Ulises", "4 review ° 8 photos", "It's very interesting these places!"),
        Review("assets/images/1 (1).jpeg", "Diego", "1 review ° 2 photos", "Excelent"),
        Review("assets/images/people2.jpg", "Arturo", "3 review ° 2 photos", "Nice!"),
